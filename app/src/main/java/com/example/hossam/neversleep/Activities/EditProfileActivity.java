...
public class EditProfileActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(this)
                .setMessage("Are you sure you want to delte this user?")
    ...
    {
        ApplicationDatabase applicationDatabase = new ApplicationDatabase(EditProfileActivity.this);
        applicationDatabase.deleteUser(user.getId());
        Intent intent = new Intent(EditProfileActivity.this, UserSelectionActivity.class);
        getSharedPreferences("prefs",MODE_PRIVATE ).edit().remove("id").commit();
